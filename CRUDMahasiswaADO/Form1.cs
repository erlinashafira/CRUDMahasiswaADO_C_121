...
namespace CRUDMahasiswaADO
{
    public partial class FormMahasiswa : Form
    {
        ...
        private readonly string connectionString = "Data Source=erlinaaa\\ERLINASHAFIRA;Initial Catalog=DBAkademikADO;Integrated Security=True";
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dbLogic.InsertMhs(txtNIM.Text,txtNama.Text,cmbJK.Text, dtpTanggalLahir.Value.Date,txtAlamat.Text,txtKodeProdi.Text,imgBytes);
                ...
                private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                byte[] imgBytes = ConvertImageToBytes(fotoMhs);
                dbLogic.UpdateMhs(txtNIM.Text, txtNama.Text, cmbJK.Text, dtpTanggalLahir.Value.Date, txtAlamat.Text, txtKodeProdi.Text, imgBytes);
        ...
        private void btnDB_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    dbLogic.InsertMhs(nim, nama, jk, tglLahir, alamat, kodeProdi, fotoBytes);
